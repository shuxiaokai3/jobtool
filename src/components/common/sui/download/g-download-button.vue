...
*/
<template>
    <el-button :loading="loading" :size="$root.VUE_BASE_CONFIG.styleConfig.size" :type="type" icon="el-icon-upload" v-bind="$attrs" v-on="$listeners" @click.stop="downloadFile">下载模板</el-button>
</template>

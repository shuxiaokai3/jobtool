...
<template>
    <s-card class="s-search">
        ...
        <div slot="operation" class="d-flex a-center">
            <el-button :size="$root.VUE_BASE_CONFIG.styleConfig.size" type="primary" :disabled="loading" @click="handleSearch">搜索</el-button>
            <el-button :size="$root.VUE_BASE_CONFIG.styleConfig.size" type="warning" :disabled="loading" @click="handleReset">重置</el-button>
            <el-button v-show="couldExpand" :size="$root.VUE_BASE_CONFIG.styleConfig.size" type="primary" :disabled="loading" @click="handleExpand">
